'''
In this python script, we need to parse the MOF cif file in a way that is appropriate to be passed to moffragmentor. We do so due to issues encountered
in structures obtained from the CSD>

Thus, first the structures should be passed through this script, and then through the script for fragmentation. 
...
while index < len(files):
    ...
    try:
        with open(os.path.join(directory, filename)) as f:
            ...
            '''
            s.to('ZrMOF_parsed/' + str(filename))
