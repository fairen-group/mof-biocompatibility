'''
Here, given a molecule or a set of molecules, we will calculate descriptors. 
This code will return a dataframe of features for the molecule(s) passed as a list of SMILES representations.
'''
